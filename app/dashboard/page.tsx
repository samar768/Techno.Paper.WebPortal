...
import { TrendingUp, TrendingDown, Package, Truck, Scale, Clock } from "lucide-react"
            ...
            <Card key={stat.title} className="bg-gray-900/50 border-gray-700 backdrop-blur-sm">
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  <div
                    className={`flex items-center text-xs ${stat.trend === "up" ? "text-green-400" : "text-red-400"}`}
                  >
                    {stat.trend === "up" ? (
            ...
            {lowStockAlerts.map((alert, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg">
                ...
                <div className="text-right space-y-1">
                  ...
                  <div className="text-xs text-gray-400">Current/Min</div>
                </div>
              </div>
            ))}
          </CardContent>
