...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-950 via-purple-800 to-purple-600 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white">PaperOps</h1>
            <p className="text-purple-200 text-sm">Paper Roll Management System</p>
          </div>
        </div>
        ...
        <Card className="bg-gray-900/50 border-gray-700 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <Button onClick={handleSignIn} className="w-full bg-purple-600 hover:bg-purple-700 text-white">
              Sign In
            </Button>
            <p className="text-center text-gray-400 text-sm">
              Need an account? <span className="text-purple-400 cursor-pointer">Sign up</span>
            </p>
          </CardContent>
        </Card>
